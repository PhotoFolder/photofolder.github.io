...
<div class="flex justify-center">
	<a href={YOUTUBE_URL} class="inline-flex justify-center">
		<!-- <img src="/landing/hero-image.webp" class=" mt-10 m-auto" alt="example of a plate" /> -->
		<img src="/youtube-thumbnail.webp" alt="PhotoFolder logo" class=" w-[200px] rounded shadow" />
...
<div class=" max-w-3xl my-16 m-auto text-center leading-10">
	...
	<p class="text-3xl md:text-4xl mt-12 drop-shadow-lg text-[#333] px-4">
		...
		<span class="font-bold text-[#800080] fill-[#800080AA] rounded-full inline-flex items-center">
			faces
		...
		and
		<span class="font-bold text-[#15803d] fill-[#15803dAA] rounded-full inline-flex items-center">
			objects

			<svg class="inline ml-2" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"
				><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
	...
	<p class="text-3xl md:text-4xl mt-12 drop-shadow-lg text-[#333] px-4">
		...
		provider or on a
		<span class="font-bold text-[#068000] fill-[#068000AA] rounded-full inline-flex items-center">
			USB drive
			<svg class="inline ml-2" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"
				><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
